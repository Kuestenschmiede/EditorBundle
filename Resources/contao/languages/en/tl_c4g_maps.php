...
$GLOBALS['TL_LANG']['tl_c4g_maps']['tDontShowIfEmpty'] = array('Don\'t show if empty', 'Hides the layer in the starboard if it does not contain content.');
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_c4g_maps']['mapsproject_legend']		= 'Editor project settings';
