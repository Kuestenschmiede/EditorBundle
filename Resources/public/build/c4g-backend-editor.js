...
exports.BackendEditor = undefined;
...
var BackendEditor = exports.BackendEditor = function (_Sideboard) {
  ...
  function BackendEditor(options) {
    ...
    // extend options
    var _this = _possibleConstructorReturn(this, (BackendEditor.__proto__ || Object.getPrototypeOf(BackendEditor)).call(this, options));
    ...
    _this.options = jQuery.extend({
      ...
      direction: 'left',
      headline: (0, _c4gMapsI18n.getLanguage)(options.mapController.data).EDITOR
      // initMode: 'select'
    }, options);
    _this.langConstants = (0, _c4gMapsI18n.getLanguage)(options.mapController.data);
  ...
  _createClass(BackendEditor, [{
    ...
    value: function addDrawView(options) {
      ...
      drawContent.className = _c4gEditorConstantCss.cssConstants['EDITOR_DRAW_CONTENT_' + options.type.toUpperCase()];
...
window.c4gMapsHooks.mapController_addControls.push(function (params) {
  ...
  var editor = new BackendEditor({
    tipLabel: (0, _c4gMapsI18n.getLanguage)(mapData).CTRL_EDITOR,
    ...
    direction: 'left',
    name: 'editor',
    headline: (0, _c4gMapsI18n.getLanguage)(mapData).EDITOR
  });
...
/******/ });
//# sourceMappingURL=c4g-backend-editor.js.map