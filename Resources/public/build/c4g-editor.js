...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../EditorBundle/node_modules/timers-browserify/main.js */ "./node_modules/timers-browserify/main.js").setImmediate, __webpack_require__(/*! ./../../../../EditorBundle/node_modules/timers-browserify/main.js */ "./node_modules/timers-browserify/main.js").clearImmediate))
...
var cssConstants = exports.cssConstants = jQuery.extend({
  ...
  _createClass(EditorDrawview, [{
    ...
    value: function addCategory(category) {
      ...
      jQuery(toggleView).click(function (event) {
        if (jQuery(this).hasClass(_c4gEditorConstantCss.cssConstants.TOGGLE_CATEGORY_OPEN)) {
          jQuery(this).removeClass(_c4gEditorConstantCss.cssConstants.TOGGLE_CATEGORY_OPEN).addClass(_c4gEditorConstantCss.cssConstants.TOGGLE_CATEGORY_CLOSED);
          elementDiv.style.display = "none";
          category.visible = false;
        } else {
          jQuery(this).removeClass(_c4gEditorConstantCss.cssConstants.TOGGLE_CATEGORY_CLOSED).addClass(_c4gEditorConstantCss.cssConstants.TOGGLE_CATEGORY_OPEN);
        ...
        if (starboard.plugins["customTab" + tabId]) {
          ...
          for (var key in layers) {
            if (layers.hasOwnProperty(key)) {
              ...
              if (jQuery(entryWrapper).hasClass(_c4gEditorConstantCss.cssConstants.OPEN)) {
          ...
          for (var _key in layers) {
            if (layers.hasOwnProperty(_key)) {
              ...
              if (unfoldedLayers[_key]) {
                jQuery(_entryWrapper).removeClass(_c4gEditorConstantCss.cssConstants.CLOSE).addClass(_c4gEditorConstantCss.cssConstants.OPEN);
              }
            }
          }
          starboard.update();
...
var EditorSelectInteraction = exports.EditorSelectInteraction = function () {
  ...
  _createClass(EditorSelectInteraction, [{
    ...
    value: function createMultiEditButtonBar() {
      ...
      jQuery(deselectButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_DESELECT_ALL);
      ...
      jQuery(deleteButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_DELETE_ALL);
      ...
      jQuery(translateButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_TRANSLATE_ALL);
      jQuery(translateButton).on('click', function (event) {
        ...
        jQuery(applyTranslationButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_APPLY);
      ...
      if (this.editor.projectController.projects.length > 1) {
        ...
        jQuery(displaceButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_DISPLACE_ALL);
        ...
        jQuery(copyDisplaceButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_COPY_DISPLACE_ALL);
    ...
    value: function showDeleteConfirmDialog(buttonBar) {
      ...
      jQuery(confirmButton).addClass(_c4gEditorConstantCss.cssConstants.ICON + " c4g-editor-dialog-confirm");
      jQuery(confirmButton).on('click', function (event) {
        scope.deleteAllElements();
      });
      var cancelButton = document.createElement("button");
      jQuery(cancelButton).addClass(_c4gEditorConstantCss.cssConstants.ICON + " c4g-editor-dialog-cancel");
...
var Editor = exports.Editor = function (_Sideboard) {
  ...
  function Editor(options) {
    ...
    if (_this.options.dataField && typeof _this.options.dataField === 'string') {
      _this.options.dataField = jQuery(_this.options.dataField) || false;
    }
    return _this;
  }
    ...
    value: function init(opt_externalinit) {
      ...
      .done(function (data) {
        ...
        if (window.c4gMapsHooks.editor_configurated && window.c4gMapsHooks.editor_configurated.length) {
          _c4gMapsUtils.utils.callHookFunctions(window.c4gMapsHooks.editor_configurated, { editor: scope, utils: _c4gMapsUtils.utils, data: data });
        }
...
var ElementUIController = exports.ElementUIController = function () {
  ...
  _createClass(ElementUIController, [{
    ...
    value: function showDeleteDialog(featureId) {
      ...
      var confirmButton = document.createElement("button");
      jQuery(confirmButton).addClass(_c4gEditorConstantCss.cssConstants.ICON + " " + _c4gEditorConstantCss.cssConstants.EDITOR_DIALOG_CONFIRM);
      jQuery(confirmButton).on('click', function (event) {
        scope.handleDeleteFeatureEvent(featureId);
      });
      container.appendChild(confirmButton);
      var cancelButton = document.createElement("button");
      jQuery(cancelButton).addClass(_c4gEditorConstantCss.cssConstants.ICON + " " + _c4gEditorConstantCss.cssConstants.EDITOR_DIALOG_CANCEL);
      jQuery(cancelButton).on('click', function (event) {
    ...
    value: function createRotateButton(index) {
      ...
      jQuery(rotateButtonElement).click(function (event) {
        ...
        jQuery(applyButton).addClass(_c4gEditorConstantCss.cssConstants.BUTTON_APPLY);
  ...
  _createClass(ProjectUIController, [{
    ...
    value: function createEditProjectButton() {
      ...
      jQuery(button).on('click', function (event) {
        ...
        jQuery(this).addClass(_c4gEditorConstantCss.cssConstants.ACTIVE);
        scope.projectButtons.forEach(function (element) {
          if (element !== this) {
            jQuery(element).removeClass(_c4gEditorConstantCss.cssConstants.ACTIVE);
          }
        });
    ...
    value: function reloadProjectControls() {
      var container = jQuery(this.editor.topToolbar).children('.' + _c4gEditorConstantCss.cssConstants.PROJECT_BUTTON_BAR)[0];
    ...
    value: function checkPermissionForButton(button, project) {
      if (jQuery(button).hasClass(_c4gEditorConstantCss.cssConstants.BUTTON_PROJECT_CREATE)) {
